...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Get in touch with NORVEGE MINERALS AS. Contact our team for inquiries, partnerships, investment opportunities, or media requests. Located in Sandefjord, Norway.",
  path: "/contact",
  keywords: [
    "contact Norvege Minerals",
    "mining company contact",
    "investor relations contact",
    "partnership inquiries",
    "Norway mining contact",
  ],
});
