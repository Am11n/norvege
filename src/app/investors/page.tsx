...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Investor information for Norvege Minerals AS. Access company presentations, financial reports, exploration updates, and investment opportunities in Norwegian mineral exploration.",
  path: "/investors",
  keywords: [
    "investor relations",
    "mining investment",
    "Norwegian mining stocks",
    "mineral exploration investment",
    "rare earth elements investment",
    "critical minerals investment",
    "mining company Norway",
  ],
  type: "website",
});
...
export default function InvestorsPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Investor Relations", url: `${siteUrl}/investors` },
  ]);

  const documentsSchema = generateItemListSchema({
    name: "Investor Documents",
    description: "Company presentations, financial reports, and exploration updates for investors",
    items: documents.map((doc) => ({
      name: doc.title,
      description: `${doc.type} document dated ${doc.date}`,
      url: `${siteUrl}/investors#${doc.title.toLowerCase().replace(/\s+/g, "-")}`,
    })),
  });

  return (
    <>
      <StructuredData data={[breadcrumbSchema, documentsSchema]} />
              ...
              >
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    >
                      NORVEGE MINERALS AS offers investors exposure to Norway&apos;s critical
                      mineral potential at a time when Europe is seeking to secure domestic sources
                      of battery metals, rare earth elements, and other minerals essential for the
                      energy transition.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{ color: "var(--color-text-body)" }}
                    >
                      Our diversified portfolio of exploration licenses, experienced management
                      team, and commitment to responsible mining position us for long-term value
                      creation.
                    </p>
                  </div>
                </div>
