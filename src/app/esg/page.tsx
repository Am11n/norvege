...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Our commitment to environmental, social, and governance excellence in mineral exploration. Learn about our sustainable mining practices, community engagement, and responsible resource development in Norway.",
  path: "/esg",
  keywords: [
    "ESG",
    "sustainable mining",
...
export default function ESGPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "ESG & Sustainability", url: `${siteUrl}/esg` },
  ]);
        ...
        <section className="section bg-white">
          <div className="container max-w-4xl">
            ...
            <p className="text-lg text-gray-600 mb-6">
              At NORVEGE MINERALS AS, we recognize that the minerals we explore are essential for
              the global energy transition. However, we also understand that how we extract these
              resources matters just as much as what we extract. We are committed to the highest
              standards of environmental stewardship, social responsibility, and corporate
              governance.
            </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  activity. Our goal is to minimize disturbance to ecosystems and protect
          ...
          <div className="container max-w-4xl">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We respect the rights of indigenous peoples, including the Sami, and ensure that
                  our operations do not infringe on traditional lands or cultural heritage.
                </p>
              </div>
          ...
          <div className="container max-w-4xl">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Our business is conducted with integrity, honesty, and respect for all
                  stakeholders. We have zero tolerance for corruption or unethical behavior.
                </p>
              </div>
            </div>
          </div>
