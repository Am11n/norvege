...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Learn about NORVEGE MINERALS AS, our mission, vision, and strategy for sustainable mineral exploration in Norway. Founded in 2020, we hold 72 exploration licenses across 2,400 km².",
  path: "/about",
  keywords: [
    "about Norvege Minerals",
        ...
        <section className="relative overflow-hidden min-h-[600px] lg:min-h-[700px] flex items-center">
          ...
          <div className="container relative z-20 pt-32 pb-20 lg:pt-36 lg:pb-28">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Building Norway&apos;s mineral future through responsible exploration and
              ...
              >
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    >
                      NORVEGE MINERALS AS is a Norwegian mining company focused on the exploration
                      and development of critical minerals essential for the global energy
                      transition. Founded on the principles of sustainable mining and community
                      engagement, we are committed to unlocking Norway&apos;s mineral potential
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  >
                    ...
                    and rare earth elements are essential for batteries, renewable energy systems,
