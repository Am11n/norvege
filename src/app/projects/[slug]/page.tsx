...
export async function generateMetadata({
  ...
  return generateSEOMetadata({
    ...
    description: `${project.description} Located in ${project.region}, ${project.country}. Stage: ${project.stage}.`,
    path: `/projects/${slug}`,
    keywords: [
      project.name.toLowerCase(),
      ...project.minerals.map((m) => m.toLowerCase()),
      "mining project",
      "mineral exploration",
      "Norway",
...
export default async function ProjectDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const projectSchema = generateProjectSchema({
    ...
    location: {
      ...
      address: `${project.region}, ${project.country}`,
    },
  ...
  return (
    <>
      <StructuredData data={[breadcrumbSchema, projectSchema]} />
